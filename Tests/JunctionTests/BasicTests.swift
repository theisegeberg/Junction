...
final class BasicTests: XCTestCase {
    ...
    func testUpdateWithRefreshFailure1() async throws {
        ...
        let failedResult = await runner.run(task: { dependency -> TaskResult<Int> in
            return .dependencyRequiresRefresh
        }, refreshDependency: {
    ...
    func testTimeoutFailure() async throws {
        ...
        let timeout:TimeInterval = TimeInterval.random(in: 1..<2)
        let successResult:Int = Int.random(in: 0...Int.max)
